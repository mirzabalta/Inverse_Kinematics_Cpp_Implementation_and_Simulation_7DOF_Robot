...
/* U funkciji criterion je implementirana fukcija cilja (2.13) koja izrazava 
   ...
   zeljene pozicije i orijentacije. Funkcija cilja u sebe ukljucuje:
      ...
      -orientationPart -  ovaj dio izrazava ostupanje trenutne orijentacije vrh
       a manipulatora (koji je funkcija zglobnih varijabli) od trenutne orijentacije.
   ...
   kinematike, koja se dobije na osnovu dh parametara robota koje cine cine 
   izglobne varijable qi. U funkciji cilja 'criterion', var.data[i][0] (i=1,2,...,n)
